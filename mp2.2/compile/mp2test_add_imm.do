echo "--- Executing initialization force file for ../testcode/mp2test_add_imm.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2test_add_imm.asm program code."
run 5
...
run 5
echo "Done loading ../testcode/mp2test_add_imm.asm program code."
