echo "--- Executing initialization force file for ../testcode/mp2test_jmp.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2test_jmp.asm program code."
run 5
...
change /mp2_cpu/DRAM/vhdl_memory/mem(4) X"BF"
...
run 5
echo "Done loading ../testcode/mp2test_jmp.asm program code."
