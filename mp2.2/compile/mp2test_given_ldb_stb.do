echo "--- Executing initialization force file for ../testcode/mp2test_given_ldb_stb.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2test_given_ldb_stb.asm program code."
run 5
...
run 5
echo "Done loading ../testcode/mp2test_given_ldb_stb.asm program code."
